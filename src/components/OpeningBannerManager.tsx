...
export default function OpeningBannerManager({
  ...
  const [formData, setFormData] = useState<Partial<OpeningBanner>>({
    id: "",
    title: "Kasir Digital Masa Kini",
    subtitle: "DCepat, Mudah, Lengkap. Kelola usaha dari mana saja dengan FORSDIGPOS..",
    imageUrl: "https://img.sanishtech.com/u/6fb3542afc5343ff9b3b2f476192ca1d.png",
    buttonText: "Baca Selengkapnya",
    buttonLink: "https://www.forsdigpos.my.id",
    isActive: true,
    status: "published",
    startDate: "",
    endDate: "",
  ...
  const handleCreateNew = () => {
    ...
    setFormData({
      ...
      title: "",
      subtitle: "Kasir Digital Masa Kini",
      imageUrl: "https://img.sanishtech.com/u/6fb3542afc5343ff9b3b2f476192ca1d.png",
      buttonText: "DAFTAR",
      buttonLink: "https://www.forsdigpos.my.id",
      isActive: true,
